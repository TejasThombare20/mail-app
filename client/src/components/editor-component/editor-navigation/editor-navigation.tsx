...
import { DeviceTypes, useEditor } from "../../../providers/email-editor/editor-provider";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "../../ui-component/Tooltip";
